  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // ─── Pure Glassmorphism Background (Header + MonthBar) ───
        ...
        title: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: const Icon(
                Icons
                    .receipt_long_rounded, // Premium structural invoice/expense icon (emoji se 10x zyada clean)
                color: kGold,
                size: 16,
              ),
            ),
              ...
              children: [
                ...
                Text(
                  ...
                  style: GoogleFonts.cairo(
                    ...
                    fontSize: 13,
                    color: kGold, // Standard gold color
                    letterSpacing: 0.4,
                  ),
                ),
              ],
        ...
        bottom: PreferredSize(
          ...
          child: Container(
            ...
            child: _MonthBar(
              ...
              onPrev: app.prevMonth,
              onNext: app.nextMonth,
              isExpense: true, // App ke existing configuration ko barkrar rakha
            ),
          ),
        ),
      ),
