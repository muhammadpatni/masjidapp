  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        scrolledUnderElevation: 0, // List scroll hone par color static rahega
        surfaceTintColor: Colors.transparent,

        // Dashboard ki tarah text ko perfectly right side par alignment dene ke liye
        titleSpacing:
            10, // Default 24 se kam karke text aur icon ko left edge se thoda aur right side par push karta hai
        // Back button ko customize kiya taake default button VIP theme ko kharab na kare

        // ─── Pure Glassmorphism Background (Body + MonthBar Dono Ke Liye) ───
                ...
                border: Border(
                  bottom: BorderSide(
                    color: Colors.white.withOpacity(
                      0.04,
                    ), // MonthBar ke theek niche barik divider
                    width: 0.8,
                  ),
                ),
              ),
        ...
        // ─── Symmetrical VIP Branding (Dashboard Se Matched) ───────────────
        title: Row(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            // Symmetrical Premium Icon Box (Dashboard jaisa unique layout)
            Container(
              ...
              child: const Icon(
                Icons
                    .volunteer_activism_rounded, // Premium "hands giving/donation" solid icon, emoji se 10x behtar
                color: kGold,
                size: 16,
              ),
            ),

            // Text Spacer (Symmetry maintain rakhne ke liye)
        ...
        // ─── Integrated Bottom MonthBar ─────────────────────────────────────
        bottom: PreferredSize(
          preferredSize: const Size.fromHeight(44),
          child: Container(
            // MonthBar ke upar halki si internal divider line line jo header aur scrollbar ko match kare
            decoration: BoxDecoration(
              border: Border(
                top: BorderSide(
