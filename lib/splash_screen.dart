...
//     _entryCtrl.forward();
//     Future.delayed(const Duration(milliseconds: 7000), _navigateAway);
//   }
...
//     // Orbiting gold dot on outer ring
...
//     // Counter-rotating dot on inner ring
...
// Updated: Auth check added — logged in → MainScreen, not logged in → AuthGateScreen
import 'dart:math' as math;
